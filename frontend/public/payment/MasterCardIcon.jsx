...
const MasterCardIcon = ({ height = "30px", width = "30px" }) => {
  return (
    <svg
      height={height}
      width={width}
    ...
    >
      <path
        style={{ fill: "#0099DF" }}
        d="M512,402.282c0,16.716-13.55,30.267-30.265,30.267H30.265C13.55,432.549,0,418.996,0,402.282V109.717
      ...
      <path
        style={{ fill: "#EA001B" }}
        d="M334.687,234.577c0-18.028,8.304-34.115,21.296-44.649c-9.872-8.005-22.455-12.806-36.156-12.806
      ...
      <path
        style={{ fill: "#F79F1A" }}
        d="M392.14,177.123c-13.703,0-26.28,4.801-36.156,12.806c12.994,10.534,21.298,26.621,21.298,44.649
      ...
      <path
        style={{ fill: "#FF5F01" }}
        d="M377.281,234.577c0-18.028-8.304-34.115-21.298-44.649c-12.991,10.534-21.296,26.621-21.296,44.649
        c0,18.027,8.304,34.113,21.296,44.645C368.976,268.69,377.281,252.604,377.281,234.577z"
      />
      <path
        style={{ fill: "#FFC715" }}
        d="M165.843,261.211c0,4.037-3.276,7.308-7.308,7.308H67.852c-4.037,0-7.308-3.271-7.308-7.308v-70.667
        c0-4.037,3.272-7.307,7.308-7.307h90.683c4.033,0,7.308,3.27,7.308,7.307V261.211L165.843,261.211z"
      />
      <g>
        <path
          style={{ fill: "#34495E" }}
          d="M166.843,331.106h-106.3c-4.611,0-8.348-3.738-8.348-8.348c0-4.611,3.736-8.348,8.348-8.348h106.3
            c4.611,0,8.348,3.736,8.348,8.348C175.191,327.368,171.454,331.106,166.843,331.106z"
        />
        <path
          style={{ fill: "#34495E" }}
          d="M166.843,365.919h-106.3c-4.611,0-8.348-3.736-8.348-8.348c0-4.611,3.736-8.348,8.348-8.348h106.3
      ...
      <g>
        <polygon
          style={{ fill: "#FFA617" }}
          points="88.893,268.52 105.589,268.52 105.589,260.172 105.589,191.584 105.589,183.236 
        ...
        <path
          style={{ fill: "#FFA617" }}
          d="M157.496,220.01h8.348v-16.696h-8.348h-15.92v-11.73v-8.348H124.88v8.348v48.509
            c0,4.61,3.736,8.348,8.348,8.348h24.268h8.348v-16.696h-8.348h-15.92V220.01H157.496z"
        />
      </g>
      <path
        style={{ opacity: "0.15", fill: "#202121", enableBackground: "new" }}
        d="M75.92,261.211v-70.667c0-4.037,3.271-7.307,7.308-7.307
